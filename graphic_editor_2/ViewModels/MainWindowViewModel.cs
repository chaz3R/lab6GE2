...
using graphic_editor_2.Views;
using ReactiveUI;
using System;
using System.Collections.ObjectModel;
using System.Reactive;

namespace graphic_editor_2.ViewModels {
    public class Log 
    {
    ...
    public class MainWindowViewModel: ViewModelBase 
    {
        ...
        private void Update() 
        {
            ...
            AddColor = valid ? valid2 ? Brushes.LightGray : Brushes.Yellow : Brushes.LightGray;
            ShapeNameColor = valid2 ? Brushes.LightGray : Brushes.Yellow;
        ...
        {
             "Blue", "DarkGray", "Green", "Red", "White", "Orange", "Brown", "Pink", "Aqua", "LightGray", "Black", "Yellow"
        };
