...
namespace graphic_editor_2.Models.Shapes {
    public class Shape3_Polygonal: IShape 
    {
        ...
        { 
            PName, PDots, PColor, PThickness, PFillColor 
        };
        ...
        public Shape? Build(Mapper map) 
        {
            ...
            if (map.GetProp(PDots) is not SafePoints @dots || !@dots.Valid)
            {
                return null;
            }
        ...
        public bool Load(Mapper map, Shape shape) 
        {
            ...
            if (map.GetProp(PDots) is not SafePoints @dots)
            {
                return false;
            }
        ...
        public Shape? Import(Dictionary<string, object?> data) 
        {
            ...
            if (!data.ContainsKey("points") || data["points"] is not Points @dots)
            {
                return null;
            }
